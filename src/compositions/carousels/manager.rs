...
use super::{UpdateDataOfComposition, carousel_basic, carousel_blurred_overlay, carousel_images};
...
impl CompositionTypeManager<CarouselType, CarouselBasicCreateReq> for CarouselTypesManager {
    fn get_public(&self, composition_type: CarouselType, composition_source_id: u128) {
        match composition_type {
            ...
            CarouselType::BlurredOverlay => carousel_blurred_overlay::get_public(composition_source_id),
            CarouselType::Images => carousel_images::get_public(composition_source_id),
        }
    }

    fn get_private(&self, composition_type: CarouselType, composition_source_id: u128, author_id: u128) {
        match composition_type {
            CarouselType::Basic => carousel_basic::get_private(composition_source_id, author_id),
            CarouselType::BlurredOverlay => carousel_blurred_overlay::get_private(composition_source_id, author_id),
            CarouselType::Images => carousel_images::get_private(composition_source_id, author_id),
        }
    }

    fn create(&self, composition_type: CarouselType, create_request: Box<dyn Any>, layout_id: u128, author_id: u128) {
        match composition_type {
    ...
    fn update(&self, composition_type: CarouselType, composition_update_que: Vec<UpdateDataOfComposition>, composition_source_id: u128, author_id: u128) {
        match composition_type {
            CarouselType::Basic => carousel_basic::update(composition_update_que, composition_source_id, author_id),
            CarouselType::BlurredOverlay => carousel_blurred_overlay::update(composition_update_que, composition_source_id, author_id),
            CarouselType::Images => carousel_images::update(composition_update_que, composition_source_id, author_id),
        }
    }
    ...
    fn delete(&self, composition_type: CarouselType, composition_source_id: u128, author_id: u128) {
        match composition_type {
            ...
            CarouselType::BlurredOverlay => carousel_blurred_overlay::delete(composition_source_id, author_id),
