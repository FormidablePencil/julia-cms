...
pub fn get_public(composition_source_id: u128) -> Option<CarouselBasicRes> {
    todo!()
}

pub fn get_private(composition_source_id: u128, author_id: u128) -> Option<CarouselBasicRes> {
    todo!()
}
